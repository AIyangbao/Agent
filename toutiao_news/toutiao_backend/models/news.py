...
class Category(Base):
    ...
    def __repr__(self):
        return f"<Category(id={self.id},name={self.name}m,sort_order={self.sort_order})>"
...
class News(Base):
    ...
    category_id: Mapped[int] = mapped_column(Integer,ForeignKey('new_category.id'),nullable=False,comment="分类ID")
